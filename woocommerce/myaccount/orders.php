								...
								if ( ! empty( $actions ) ) {
									foreach ( $actions as $key => $action ) {
										if($action['name'] == 'Cancel'){
											$cancel_class = 'cancel_orders_woo ';
										}
										else{
											$cancel_class = '';
										}
										echo '<a href="' . esc_url( $action['url'] ) . '" class="'.$cancel_class.'woocommerce-button button ' . sanitize_html_class( $key ) . '">' . esc_html( $action['name'] ) . '</a>';
										if($action['name'] == 'Cancel'){?>
											  ...
											  <!-- Modal content -->
												<div class="modal-content">
												    ...
												    <div class="modal-footer">
												        <a href="<?php echo esc_url( $action['url'] ); ?>" class="btn btn-default text-center <?php echo sanitize_html_class( $key ) ?>" id="modal-btn-yes">Yes</a>
...
jQuery('.cancel_orders_woo').on('click',function(e){
	e.preventDefault();
